...
- crudproject-addon: addon module, custom server and client side code 
- crudproject-ui: main application module
- crudproject-backend: backend module, contains any server side java code and dependencies
